...
| Segmentación interna de Cliente | `CI` | Wallet, perfil, libreta, dieta, Actividad, Envíos, tarjeta de estado y los tres trackings viven en módulos propios; `test:responsive-layout` y `test:web-tracking-maps` fijan 1.635/575/130/315/165/195/180/340/285 líneas y APIs propietarias. Chromium verifica Cuenta, cotizador y los tres trackings a 390 × 844; el envío activo faltante se cotiza/crea por API real e idempotente |
