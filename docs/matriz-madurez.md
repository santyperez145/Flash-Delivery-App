...
| 131 migraciones versionadas | `CI` | `ci-postgres.yml` corre desde cero y de forma incremental sobre la rama base |
...
| Alcance de permisos del runtime | `CI` | `test:grant-scope` y `test:runtime-write-scope`. Las migraciones 116, 122, 123 y 131 reducen los permisos DML sin uso de 114 a 60; el último lote verifica por nombre once artefactos de identidad sin DELETE |
