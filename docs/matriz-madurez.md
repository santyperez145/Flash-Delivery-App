...
| Segmentación interna de Cliente | `CI` | Cuenta, Actividad, tracking, Viajes, Envíos y las cinco tareas de Comidas viven fuera de `CustomerScreen.tsx`; `test:responsive-layout` y `test:mobile-food-design` fijan el coordinador en 1.600 líneas o menos |
