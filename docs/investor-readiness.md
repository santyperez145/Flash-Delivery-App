...
- Arquitectura considerablemente más seria que la mayoría de proyectos en etapa temprana: PostgreSQL/PostGIS con 126 migraciones, RLS, ledger de doble entrada, auditoría encadenada con SHA-256, idempotencia, dispatch geoespacial con aceptación atómica y realtime durable con replay.
...
- PostgreSQL/PostGIS con 126 migraciones versionadas.
