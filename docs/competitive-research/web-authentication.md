...
3. La portada pública sigue el patrón de uber.com —nav persistente, hero a
   sangre completa, titular de conversión y CTA— con identidad Flash. **El
   formulario de login no vive en la landing**: «Ingresar» abre una superficie
   de acceso aparte. No se dibuja un cotizador anónimo ni ciudades/métricas
   inventadas. Compact oculta nav de links y el visual del hero; conserva
   titular + CTAs. No se dibujan Apple, Google, passkeys, SMS ni biometría
   porque esos proveedores no están integrados.
