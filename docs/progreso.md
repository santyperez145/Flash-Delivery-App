...
Flash es una **plataforma de preproducción avanzada** con cuatro superficies: cliente, comercio, conductor/repartidor y operaciones. El runtime principal es PostgreSQL/PostGIS con 137 migraciones versionadas; SQLite quedó reducido a fallback aislado de tests.
