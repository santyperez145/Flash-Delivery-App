...
- Actividad web/PWA incorpora tracking dedicado de viajes: ruta OSRM, vehículo/placa/rating, PIN de retiro, enlace temporal de seguimiento y reporte de incidentes conectado a la API autenticada.
