...
- [ ] Ninguna línea de más de 200 caracteres. Quedan **170** (bajan de 251): tip/risk/zone/catalog/openapi, luego `mobility-repository`, `operations-repository` y `order-repository`. El resto son SQL (y smokes); `test:line-length` fija el techo.
