...
- [ ] `server/index.js` deja de contener lógica de dominio. **19 de 57 grupos de rutas extraídos**; quedan 152 rutas en 36 grupos. `index.js` bajó de 9.696 a 7.311 líneas.
