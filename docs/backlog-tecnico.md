...
7. Limitar cada archivo a una responsabilidad concreta. **Avance:** backoffice modularizado (`AdminConsole` shell + overview/home); Driver: `useDriverShift` + paneles (`DriverScreen` cockpit).
