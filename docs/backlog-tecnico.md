...
7. Limitar cada archivo a una responsabilidad concreta. **Avance:** horarios, modificadores y declaración alimentaria salieron de `MerchantConsole.tsx` a `MerchantCatalogEditors.tsx`.
