...
- [ ] `server/index.js` deja de contener lógica de dominio. **14 de 57 grupos de rutas extraídos**; quedan 162 rutas en 40 grupos. `index.js` bajó de 9.696 a 7.665 líneas.
