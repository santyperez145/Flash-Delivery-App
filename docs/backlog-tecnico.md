...
- [ ] Ninguna línea de más de 200 caracteres. Quedan **~80** (bajan de 251): casi todo el SQL de `server/*-repository.js` ya está partido; el remanente son smokes en `scripts/`. `test:line-length` fija el techo.
