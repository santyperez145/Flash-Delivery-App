...
7. Limitar cada archivo a una responsabilidad concreta. **Avance:** backoffice partido en finance/shipment/support/trust/overview/marketplace (`AdminConsole` ~499). Driver: guía/firma, cuenta, ganancias, inbox, tarjetas y home operativo en módulos propios (`DriverScreen` ~569).
