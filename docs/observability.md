...
- Dispatch: 95 % de jobs elegibles con primera oferta en menos de **5 s** (mismo SLO que DSP-001 / `test:dispatch-plan`; evidencia CI sobre padrón sintético, falta medición en producción).
