...
//
// Primer corte de `src/App.tsx`. Los paneles de tarifas, payouts, propinas y
// conciliación viven en `AdminFinancePanels.tsx` para bajar la concentración
// operativa sin cambiar comportamiento.
import {
  BadgeDollarSign,
  Bike,
  Car,
