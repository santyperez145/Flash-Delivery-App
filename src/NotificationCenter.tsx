      ...
      <section className="address-book-card notification-center-header">
        <div className="address-book-heading">
          <div>
            ...
            <p>
              {unread ? `${unread} sin leer` : "Estás al día"}. Las actualizaciones transaccionales
      ...
      <section className="address-book-card">
        <div className="address-book-heading">
          <div>
            ...
            <p>
              Push y email se guardan por categoría. Los proveedores externos se habilitan cuando la
              cuenta productiva esté configurada.
            </p>
          </div>
          ...
          {state.notificationPreferences.map((preference) => (
            <div className="notification-preference" key={preference.category}>
              <div>
                ...
                <span>
                  {preference.pushEnabled ? "Push habilitado" : "Sólo dentro de la app"}
                  {preference.emailEnabled ? " · Email habilitado" : ""}
                </span>
              </div>
              <button
                aria-checked={preference.pushEnabled}
                className={
                  preference.pushEnabled ? "preference-toggle active" : "preference-toggle"
                }
                disabled={busy}
                onClick={() =>
                  runAction(
                    () =>
                      api.updateNotificationPreference(preference.category, {
