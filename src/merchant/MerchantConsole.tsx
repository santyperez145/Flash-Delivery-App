...
//
// De las cinco, **sólo `MerchantDesktopConsole` cruza la frontera**; las otras
// cuatro se usan únicamente acá adentro. `OrderOpsCard` iba en sentido
// contrario: la usa este bloque y también el conductor y operaciones, así que
// salió antes a [`../ui/panels.tsx`](../ui/panels.tsx).
//
