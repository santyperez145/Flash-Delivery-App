...
for (const name of ["FlashApiFastErrorBudgetBurn","FlashApiSlowErrorBudgetBurn","FlashApiP95LatencyHigh","FlashPostgresPoolSaturated","FlashNotificationDeadLetters","FlashMerchantPaymentOAuthReconnectRequired"]) {
