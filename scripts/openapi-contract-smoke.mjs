...
try {
  ...
  assert(anonymousMerchantDashboard.status===401&&spec.paths["/api/merchant/dashboard"].get.security&&spec.components.schemas.MerchantOperationsMetrics.required.includes("untrackedPrepOrders"),"operación del comercio exige identidad y conserva brechas históricas explícitas");
