...
if (!fs.existsSync(manifestPath))
  throw new Error("Falta dist/.vite/manifest.json; ejecutá npm run build primero");
...
console.log(
  `ok - entry ${format(entryBytes)}; JS inicial ${format(initialBytes)} en ${initialFiles.size} chunks cacheables`,
);
