...
// Envíos y las hojas de seguimiento viven en módulos separados. La sesión de
// Comidas vive en useCustomerFood — la misma frontera que Uber Eats.
...
import { CustomerFoodBrowseScreen } from "./CustomerFoodBrowseScreen";
import { useCustomerFood } from "./useCustomerFood";
...
export function CustomerScreen({
  ...
  const {
    ...
    createOrder,
    loadMoreCatalog,
  } = useCustomerFood({ state, user, runAction, setSharedView });
