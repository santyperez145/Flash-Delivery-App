// Coordinador del cliente (ticket ARC-001). El shell, Actividad, Cuenta y las hojas de
// seguimiento ya viven en módulos separados; este archivo conserva la coordinación
// de Comidas, Viajes y Envíos durante la extracción.
