// Coordinador del cliente (ticket ARC-001). El shell, Actividad, Cuenta, Envíos y las
// hojas de seguimiento ya viven en módulos separados; este archivo conserva la
// coordinación de Comidas y Viajes durante la extracción.
...
export function CustomerScreen({
  ...
  }, [pickup, pickupCoords, state.addresses, user.defaultAddress, user.id]);
