...
// Actividad y las hojas de seguimiento ya viven en módulos separados; este archivo
// conserva la coordinación de Comidas, Viajes, Envíos y Cuenta durante la extracción.
