...
| H-08 | ARC-001 | **En curso.** Reformateo hecho y **núcleo HTTP compartido completo**: respuestas, autorización, autenticación, realtime y runtime del fallback. 9 de 57 grupos de rutas extraídos, `src/App.tsx` 10.553 → 7.420 y `apps/mobile/App.tsx` 15.374 → **321**, ya bajo el techo de 1.500; falta el web, los entrypoints por audiencia y los 48 grupos de rutas restantes |
