...
| H-08 | ARC-001 | **En curso.** Reformateo hecho y **núcleo HTTP compartido completo**: respuestas, autorización, autenticación, realtime y runtime del fallback. 9 de 57 grupos de rutas extraídos y `src/App.tsx` de 10.553 a 7.420 líneas; falta separar entrypoints, los 48 grupos restantes y `apps/mobile/App.tsx` |
