...
| H-08 | ARC-001 | **En curso.** Reformateo hecho y núcleo compartido en marcha: `responses`, `authorization`, `realtime` y 3 de 57 grupos de rutas extraídos. Falta separar entrypoints y los 54 grupos restantes |
