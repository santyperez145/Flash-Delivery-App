...
| H-08 | ARC-001 | **En curso.** Los dos `App.tsx` cumplen el techo de 1.500; `server/index.js` ~350 líneas (sólo montaje); contratos compartidos en 39 tipos; faltan entrypoints/binarios por audiencia (MOB-001) |
