...
| H-08 | ARC-001 | **En curso.** **Los dos `App.tsx` cumplen el techo de 1.500**: `src/App.tsx` 10.553 → **1.245** y `apps/mobile/App.tsx` 15.374 → **321**. Núcleo HTTP compartido completo y 12 de 57 grupos de rutas extraídos; faltan los entrypoints separados por audiencia y los 42 grupos restantes |
