// Envíos (shipments): cotización de protección, claims, POD y estados (ARC-001).
//
// Los viajes viven en `ride-repository.js`. Este archivo conserva el nombre
// histórico `mobility-repository` porque varios routers y smokes ya lo importan
// para el dominio courier; el corte es por dueño del dato, no por rename masivo.
