// Envíos (shipments): ciclo create/status, claims, POD (ARC-001).
//
// Viajes → `ride-repository.js`. Catálogo de protección/categorías/niveles →
// `shipment-options-repository.js`. Este archivo conserva el nombre histórico
// porque routers y smokes ya lo importan para el dominio courier.
