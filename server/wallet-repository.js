// Flash Wallet: saldo, cobro, crédito y liquidación de movilidad (ARC-001).
//
// Cuentas → `wallet-ledger-accounts.js`. Ganancias conductor →
// `driver-earnings-repository.js`. Reintegros por cancelación →
// `wallet-refund-repository.js`.
