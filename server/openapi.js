...
Object.assign(openApiDocument.components.schemas, {
  ...
  RideCreateRequest: { allOf: [{ $ref: "#/components/schemas/RideQuoteRequest" }, { type: "object", required: ["customerId", "paymentMethod"], properties: { customerId: { type: "string" }, paymentMethod: { type: "string", minLength: 2 }, quoteToken: { type: "string", minLength: 20, writeOnly: true }, scheduledFor: { type: "string", format: "date-time", description: "Entre 30 minutos y 30 días en el futuro." } } }] },
