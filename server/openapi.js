...
const operationsPageParameters=[{name:"limit",in:"query",required:false,schema:{type:"integer",minimum:1,maximum:100,default:50}},{name:"cursor",in:"query",required:false,schema:{type:"string"}},{name:"q",in:"query",required:false,schema:{type:"string",maxLength:100}}];
...
Object.assign(openApiDocument.paths, {
  ...
  "/api/driver/offers":{get:{tags:["Dispatch"],operationId:"listDriverOffers",summary:"Listar ofertas privadas vigentes del conductor",security:[{bearerAuth:[]}],responses:{200:success({$ref:"#/components/schemas/DispatchOffersResponse"}),400:errorResponses[400],401:errorResponses[401],403:bearerErrors[403],429:errorResponses[429]}}},
  "/api/driver/offers/{offerId}/reject":{post:{tags:["Dispatch"],operationId:"rejectDriverOffer",summary:"Rechazar una oferta propia todavía vigente",security:[{bearerAuth:[]}],parameters:[{name:"offerId",in:"path",required:true,schema:{type:"string",minLength:3}}],requestBody:{required:false,content:{"application/json":{schema:{type:"object",additionalProperties:false}}}},responses:{200:success({type:"object",required:["ok","requestId","rejected"],properties:{ok:{const:true},requestId:{type:"string"},rejected:{const:true}}}),400:errorResponses[400],401:errorResponses[401],403:bearerErrors[403],409:{description:"Oferta inexistente, vencida o resuelta",content:json},429:errorResponses[429]}}},
  "/api/support/tickets":{get:{tags:["Support"],operationId:"listSupportTickets",summary:"Listar tickets visibles para la identidad",security:[{bearerAuth:[]}],responses:{200:success({$ref:"#/components/schemas/SupportTicketsResponse"}),401:errorResponses[401],429:errorResponses[429]}},post:{tags:["Support"],operationId:"createSupportTicket",summary:"Crear ticket persistente y auditable",security:[{bearerAuth:[]}],parameters:[idempotencyHeader],requestBody:body("SupportTicketCreateRequest"),responses:{201:success({$ref:"#/components/schemas/SupportTicketResponse"}),400:errorResponses[400],401:errorResponses[401],409:{description:"Clave reutilizada con otro payload o solicitud en proceso",content:json},429:errorResponses[429],503:{description:"Soporte real requiere PostgreSQL",content:json}}}},
  "/api/support/tickets/{ticketId}/messages":{post:{tags:["Support"],operationId:"addSupportMessage",summary:"Agregar mensaje a un ticket visible",security:[{bearerAuth:[]}],parameters:[{name:"ticketId",in:"path",required:true,schema:{type:"string",minLength:3}},idempotencyHeader],requestBody:body("SupportMessageRequest"),responses:{200:success({$ref:"#/components/schemas/SupportTicketResponse"}),400:errorResponses[400],401:errorResponses[401],403:bearerErrors[403],404:{description:"Ticket inexistente o ajeno",content:json},409:{description:"Clave reutilizada con otro mensaje o escritura en proceso",content:json},429:errorResponses[429],503:{description:"Soporte real requiere PostgreSQL",content:json}}}},
  "/api/support/tickets/{ticketId}":{patch:{tags:["Support"],operationId:"updateSupportTicket",summary:"Actualizar estado, prioridad o asignación como agente",security:[{bearerAuth:[]}],parameters:[{name:"ticketId",in:"path",required:true,schema:{type:"string",minLength:3}}],requestBody:body("SupportTicketUpdateRequest"),responses:{200:success({$ref:"#/components/schemas/SupportTicketResponse"}),400:errorResponses[400],401:errorResponses[401],403:bearerErrors[403],404:{description:"Ticket inexistente",content:json},429:errorResponses[429]}}},
  "/api/operations/restaurants":{get:{tags:["Operations"],operationId:"listOperationsRestaurants",summary:"Paginar comercios para backoffice",security:[{bearerAuth:[]}],parameters:operationsPageParameters,responses:{200:success({$ref:"#/components/schemas/OperationsPageResponse"}),400:errorResponses[400],401:errorResponses[401],403:bearerErrors[403],429:errorResponses[429]}}},
  "/api/operations/drivers":{get:{tags:["Operations"],operationId:"listOperationsDrivers",summary:"Paginar conductores para backoffice",security:[{bearerAuth:[]}],parameters:operationsPageParameters,responses:{200:success({$ref:"#/components/schemas/OperationsPageResponse"}),400:errorResponses[400],401:errorResponses[401],403:bearerErrors[403],429:errorResponses[429]}}},
  "/api/operations/users":{get:{tags:["Operations"],operationId:"listOperationsUsers",summary:"Paginar usuarios para backoffice",security:[{bearerAuth:[]}],parameters:operationsPageParameters,responses:{200:success({$ref:"#/components/schemas/OperationsPageResponse"}),400:errorResponses[400],401:errorResponses[401],403:bearerErrors[403],429:errorResponses[429]}}},
  "/api/operations/support-tickets":{get:{tags:["Operations"],operationId:"listOperationsSupportTickets",summary:"Paginar mesa de ayuda completa",security:[{bearerAuth:[]}],parameters:operationsPageParameters,responses:{200:success({$ref:"#/components/schemas/OperationsPageResponse"}),400:errorResponses[400],401:errorResponses[401],403:bearerErrors[403],429:errorResponses[429]}}},
  "/api/operations/audit-events":{get:{tags:["Operations"],operationId:"listOperationsAuditEvents",summary:"Paginar auditoría sanitizada",security:[{bearerAuth:[]}],parameters:operationsPageParameters,responses:{200:success({$ref:"#/components/schemas/OperationsPageResponse"}),400:errorResponses[400],401:errorResponses[401],403:bearerErrors[403],429:errorResponses[429]}}},
  "/api/operations/feature-flags":{get:{tags:["Operations"],operationId:"listFeatureFlags",summary:"Listar configuración de rollout",security:[{bearerAuth:[]}],responses:{200:success({$ref:"#/components/schemas/FeatureFlagsResponse"}),401:errorResponses[401],403:bearerErrors[403],429:errorResponses[429]}}},
  "/api/operations/feature-flags/{flagId}":{patch:{tags:["Operations"],operationId:"updateFeatureFlag",summary:"Actualizar rollout con auditoría",security:[{bearerAuth:[]}],parameters:[{name:"flagId",in:"path",required:true,schema:{type:"string",minLength:3}}],requestBody:body("FeatureFlagUpdateRequest"),responses:{200:success({$ref:"#/components/schemas/FeatureFlagResponse"}),400:errorResponses[400],401:errorResponses[401],403:bearerErrors[403],404:{description:"Feature flag inexistente",content:json},429:errorResponses[429]}}},
  "/api/operations/product-metrics":{get:{tags:["Operations"],operationId:"getProductMetrics",summary:"Obtener embudo agregado sin PII",security:[{bearerAuth:[]}],parameters:[{name:"days",in:"query",required:false,schema:{type:"integer",minimum:1,maximum:90,default:7}}],responses:{200:success({type:"object"}),401:errorResponses[401],403:bearerErrors[403],429:errorResponses[429]}}},
  "/api/operations/zones/{zoneId}/readiness":{get:{tags:["Operations"],operationId:"getZoneReadiness",summary:"Evaluar condiciones reales para habilitar una zona",security:[{bearerAuth:[]}],parameters:[{name:"zoneId",in:"path",required:true,schema:{type:"string",minLength:3}}],responses:{200:success({type:"object"}),401:errorResponses[401],403:bearerErrors[403],404:{description:"Zona inexistente",content:json},429:errorResponses[429]}}},
  "/api/operations/zones/{zoneId}/readiness-assessments":{post:{tags:["Operations"],operationId:"createZoneReadinessAssessment",summary:"Persistir decisión de readiness auditable",security:[{bearerAuth:[]}],parameters:[{name:"zoneId",in:"path",required:true,schema:{type:"string",minLength:3}}],requestBody:{required:false,content:{"application/json":{schema:{type:"object",additionalProperties:false}}}},responses:{201:success({type:"object"}),401:errorResponses[401],403:bearerErrors[403],404:{description:"Zona inexistente",content:json},429:errorResponses[429]}}},
});
...
openApiDocument.tags.push(
  ...
  { name: "Operations", description: "Backoffice administrativo paginado, auditable y sin secretos" },
);
...
Object.assign(openApiDocument.components.schemas, {
  ...
  DispatchOffer:{type:"object",required:["id","jobId","kind","pickup","destination","fare","distanceKm","durationMin","expiresAt","status"],properties:{id:{type:"string"},jobId:{type:"string"},kind:{enum:["delivery","ride"]},serviceLevel:{type:"string"},pickup:{type:"string"},destination:{type:"string"},fare:{type:"number",minimum:0},distanceKm:{type:"number",minimum:0},durationMin:{type:"integer",minimum:0},score:{type:"number"},scoreBreakdown:{type:"object"},expiresAt:{type:"string",format:"date-time"},status:{const:"pending"},subtype:{type:["string","null"]}}},
  DispatchOffersResponse:{type:"object",required:["ok","requestId","offers"],properties:{ok:{const:true},requestId:{type:"string"},offers:{type:"array",items:{$ref:"#/components/schemas/DispatchOffer"}}}},
  SupportTicketCreateRequest:{type:"object",additionalProperties:false,required:["category","subject","body"],properties:{category:{enum:["food","ride","shipment","payment","account","safety","other"]},priority:{enum:["low","normal","high","urgent"],default:"normal"},subject:{type:"string",minLength:4,maxLength:160},body:{type:"string",minLength:4,maxLength:5000},jobId:{type:"string",maxLength:64}}},
  SupportMessageRequest:{type:"object",additionalProperties:false,required:["body"],properties:{body:{type:"string",minLength:1,maxLength:5000},internal:{type:"boolean",default:false,description:"Sólo roles support/admin pueden crear notas internas."}}},
  SupportTicketUpdateRequest:{type:"object",minProperties:1,additionalProperties:false,properties:{status:{enum:["open","waiting_customer","waiting_operations","resolved","closed"]},priority:{enum:["low","normal","high","urgent"]},assignedTo:{type:"string",maxLength:64}}},
  SupportTicket:{type:"object",required:["id","service","priority","title","status","messages"],properties:{id:{type:"string"},service:{enum:["food","ride","shipment","payment","account","safety","other"]},priority:{enum:["low","medium","high","urgent"]},title:{type:"string"},status:{enum:["open","waiting_customer","waiting_operations","resolved","closed"]},messages:{type:"array",items:{type:"object"}},createdAt:{type:"string",format:"date-time"},updatedAt:{type:"string",format:"date-time"}}},
  SupportTicketResponse:{type:"object",required:["ok","requestId","ticket"],properties:{ok:{const:true},requestId:{type:"string"},ticket:{$ref:"#/components/schemas/SupportTicket"}}},
  SupportTicketsResponse:{type:"object",required:["ok","requestId","tickets"],properties:{ok:{const:true},requestId:{type:"string"},tickets:{type:"array",items:{$ref:"#/components/schemas/SupportTicket"}}}},
  OperationsPageResponse:{type:"object",required:["ok","requestId"],properties:{ok:{const:true},requestId:{type:"string"},nextCursor:{type:["string","null"]},restaurants:{type:"array",items:{type:"object"}},drivers:{type:"array",items:{type:"object"}},users:{type:"array",items:{type:"object"}},tickets:{type:"array",items:{type:"object"}},events:{type:"array",items:{type:"object"}}}},
  FeatureFlag:{type:"object",required:["id","key","description","enabled","rolloutPercentage","allowedRoles","variant","updatedAt"],properties:{id:{type:"string"},key:{type:"string"},description:{type:"string"},enabled:{type:"boolean"},rolloutPercentage:{type:"integer",minimum:0,maximum:100},allowedRoles:{type:"array",items:{enum:["customer","merchant","driver","admin","support"]}},city:{type:["string","null"]},startsAt:{type:["string","null"],format:"date-time"},endsAt:{type:["string","null"],format:"date-time"},variant:{type:"object"},updatedAt:{type:"string",format:"date-time"}}},
  FeatureFlagUpdateRequest:{type:"object",minProperties:1,additionalProperties:false,properties:{enabled:{type:"boolean"},rolloutPercentage:{type:"integer",minimum:0,maximum:100},allowedRoles:{type:"array",maxItems:5,items:{enum:["customer","merchant","driver","admin","support"]}},startsAt:{type:["string","null"],format:"date-time"},endsAt:{type:["string","null"],format:"date-time"},variant:{type:"object",additionalProperties:{oneOf:[{type:"string"},{type:"number"},{type:"boolean"},{type:"null"}]}}}},
  FeatureFlagResponse:{type:"object",required:["ok","requestId","flag"],properties:{ok:{const:true},requestId:{type:"string"},flag:{$ref:"#/components/schemas/FeatureFlag"}}},
  FeatureFlagsResponse:{type:"object",required:["ok","requestId","flags"],properties:{ok:{const:true},requestId:{type:"string"},flags:{type:"array",items:{$ref:"#/components/schemas/FeatureFlag"}}}},
});
