...
Object.assign(openApiDocument.paths, {
  ...
  "/api/support/tickets":{get:{tags:["Support"],operationId:"listSupportTickets",summary:"Listar tickets visibles para la identidad",security:[{bearerAuth:[]}],responses:{200:success({$ref:"#/components/schemas/SupportTicketsResponse"}),401:errorResponses[401],429:errorResponses[429]}},post:{tags:["Support"],operationId:"createSupportTicket",summary:"Crear ticket persistente y auditable",security:[{bearerAuth:[]}],requestBody:body("SupportTicketCreateRequest"),responses:{201:success({$ref:"#/components/schemas/SupportTicketResponse"}),400:errorResponses[400],401:errorResponses[401],429:errorResponses[429],503:{description:"Soporte real requiere PostgreSQL",content:json}}}},
