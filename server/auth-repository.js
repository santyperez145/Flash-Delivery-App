// Identidad y sesión (ARC-001).
//
// Direcciones → `address-repository.js`. Métodos de pago sandbox →
// `payment-method-repository.js`. Acá quedan recovery, login, usuarios,
// registro, verificación, sesiones y perfil.
