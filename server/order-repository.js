// El ciclo del pedido: cotizar, crear, cobrar y avanzar (ticket ARC-001).
//
// Carrito y reorder viven en `cart-repository.js`; la selección de agregados
// en `order-selection.js`. Acá queda la cotización versionada, la creación,
// el pago de marketplace, la asignación de conductor y la máquina de estados.
//
